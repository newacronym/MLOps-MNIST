...
with mlflow.start_run():
  numepochs = 5
  mlflow.log_param('numepochs', numepochs)

  # Train the model
  trainAcc,testAcc,losses,net = function2trainTheModel(numepochs=numepochs)

  # Log metrtcs
  for epoch, train_accuracy in enumerate(trainAcc):
    mlflow.log_metric('train_accuracy', train_accuracy, step=epoch)
  for epoch, test_accuracy in enumerate(testAcc):
  ...
  # 2. mlflow model
  mlflow.pytorch.log_model(net, "mnist_model_mlflow")
